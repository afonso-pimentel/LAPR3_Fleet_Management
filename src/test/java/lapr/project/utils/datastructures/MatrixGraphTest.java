...
public class MatrixGraphTest {
    ...
    @Test
    public void testConstructionOfGraph(){
        // Arrange
        List<String> vertices = new ArrayList<>();
        vertices.add("Porto");
        vertices.add("Lisboa");
        vertices.add("Setubal");

        Integer [][] edges = new Integer[3][3];
        edges[0][0] = 3;
        edges[0][1] = 3;
        edges[0][2] = 3;
        ...
        // Act
        MatrixGraph<String, Integer> result = new MatrixGraph<>(false, vertices, edges);
    ...
    @Test
    public void testAdjVerticesFromVertex(){
        // Arrange
        MatrixGraph<String, Integer> graph = getMatrixGraph();

        // Act
        Collection<String> adjVertices = graph.adjVertices("Porto");

        // Assert
        assertEquals(2, adjVertices.size());
        assertTrue(adjVertices.contains("Lisboa"));
        assertTrue(adjVertices.contains("Setubal"));
    }

    @Test
    public void testAdjVerticesForNonExistentVertex(){
        // Arrange
        MatrixGraph<String, Integer> graph = getMatrixGraph();

        // Act
        Collection<String> adjVertices = graph.adjVertices("NON-EXISTENT");

        // Assert
        assertEquals(0, adjVertices.size());
    }
    ...
    public void testGetEdgeByVertex(){
        ...
        // Act
        Edge<String, Integer> result = graph.edge(10,10);
    ...
    @Test
    public void testGetEdgeByVertex2(){
        // Arrange
        MatrixGraph<String, Integer> graph = getMatrixGraph();

        // Act
        Edge<String, Integer> result = graph.edge(0,1);
    ...
    public void testOutDegree2(){
        ...
        // Act
        int result = graph.outDegree("Porto");
    ...
    public void testOutGoingEdges(){
        ...
        // Act
        Collection<Edge<String, Integer>> result = graph.outgoingEdges("NOEXISTENT");
    ...
    public void testToString(){
        ...
        String expected2 = expectedToString();

        // Act
        String result = new MatrixGraph<>(false).toString();
        String result2 = getMatrixGraph().toString();
    ...
    public void testEquals2(){
        ...
        // Act
        boolean resultNull = graph.equals(null);
        boolean resultEqual = graph.equals(graph);
        boolean resultDifferentClass = graph.equals(new Integer(3));

        // Assert
        assertFalse(resultNull);
        assertTrue(resultEqual);
        assertFalse(resultDifferentClass);
    }
    ...
    public void testIncomingEdges2(){
        ...
        // Act
        Collection<Edge<String, Integer>> result = graph.incomingEdges("Porto");
        Collection<Edge<String, Integer>> result2 = graph.incomingEdges("INEXISTANT");
        // Assert
    ...
    public void testAddVertex2(){
        ...
        // Act
        boolean result = graph.addVertex("Porto");
        boolean result2 = graph.addVertex("Sines");
    ...
    public void addEdge2(){
        // Arrange
        MatrixGraph<String, Integer> graph = getMatrixGraph();
        graph.addVertex("Sines");

        // Act
        int numEdgesBefore = graph.numEdges;

        boolean result = graph.addEdge("Porto", "Sines", 3);
        boolean result2 = graph.addEdge("Porto", "Sines", 3);

        int numEdgesAfter = graph.numEdges;

        // Assert
        assertEquals(numEdgesBefore + 2, numEdgesAfter);
        assertTrue(result);
        assertFalse(result2);
    }
    ...
    private String expectedToString(){
        return "Vertices:\n" +
                ...
                "\n" +
                "Edges:\n" +
                "From 0 to 1-> Graph Edge => [ Porto ]  --> [Lisboa] \n" +
                " Weight: 3 \n" +
                "From 0 to 2-> Graph Edge => [ Porto ]  --> [Setubal] \n" +
                " Weight: 3 \n" +
                "From 1 to 0-> Graph Edge => [ Lisboa ]  --> [Porto] \n" +
                " Weight: 3 \n" +
                "From 1 to 2-> Graph Edge => [ Lisboa ]  --> [Setubal] \n" +
                " Weight: 3 \n" +
                "From 2 to 0-> Graph Edge => [ Setubal ]  --> [Porto] \n" +
                " Weight: 3 \n" +
                "From 2 to 1-> Graph Edge => [ Setubal ]  --> [Lisboa] \n" +
                " Weight: 3 \n" +
                "\n";
    }

    private MatrixGraph<String, Integer> getMatrixGraph(){
        List<String> vertices = new ArrayList<>();
        vertices.add("Porto");
        vertices.add("Lisboa");
        vertices.add("Setubal");
        ...
        return new MatrixGraph<>(false, vertices, edges);
    }
}