 ...
 */
public class FreightNetworkFileImplTests {
    private final FreightNetworkImpl freightNetworkImpl;
    private Graph<FreightNetworkNode, Float> testFreightNetworkFromFile;

    public FreightNetworkFileImplTests() throws IOException {
    ...
    public void setUp() throws IOException {
        ...
        testFreightNetworkFromFile = freightNetworkImpl.getFreightNetwork();
    }
    ...
    public void testAcceptanceCriteriaCapitalToBorderCapitalsConnection() throws IOException {
        ...
        // Assert
        Edge<FreightNetworkNode, Float> resultArgentinaBoliviaConnection = this.testFreightNetworkFromFile.edge(argentinaStartingCapitalNode, expectedBoliviaCapitalNode);
        Edge<FreightNetworkNode, Float> resultArgentinaBrazilConnection = this.testFreightNetworkFromFile.edge(argentinaStartingCapitalNode, expectedBrazilCapitalNode);
        Edge<FreightNetworkNode, Float> resultArgentinaChileConnection = this.testFreightNetworkFromFile.edge(argentinaStartingCapitalNode, expectedChileCapitalNode);
        Edge<FreightNetworkNode, Float> resultArgentinaParaguayConnection = this.testFreightNetworkFromFile.edge(argentinaStartingCapitalNode, expectedParaguayCapitalNode);
        Edge<FreightNetworkNode, Float> resultArgentinaUruguayConnection = this.testFreightNetworkFromFile.edge(argentinaStartingCapitalNode, expectedUruguayCapitalNode);

        Edge<FreightNetworkNode, Float> resultPortugalSpainConnection = this.testFreightNetworkFromFile.edge(portugalStartingCapitalNode, expectedSpainCapitalNode);
    ...
    public void testAcceptanceCriteriaPortConnectionToPortsWithinSameCountry() throws IOException {
        ...
        // Assert
        Edge<FreightNetworkNode, Float> resultArgentinaBahiaAndBuenosAiresConnection = this.testFreightNetworkFromFile.edge(originPortNodeArgentina, destinationPortNodeArgentina);
        Edge<FreightNetworkNode, Float> resultPortugalFunchalAndLeixoesConnection = this.testFreightNetworkFromFile.edge(originPortNodePortugal, destinationPortNodePortugal1);
        Edge<FreightNetworkNode, Float> resultPortugalFunchalAndSetubalConnection = this.testFreightNetworkFromFile.edge(originPortNodePortugal, destinationPortNodePortugal2);
        Edge<FreightNetworkNode, Float> resultPortugalFunchalAndHortaConnection = this.testFreightNetworkFromFile.edge(originPortNodePortugal, destinationPortNodePortugal3);
    ...
    public void testAcceptanceCriteriaConnectionClosestPortToCapital(){
        ...
        // Assert
        Edge<FreightNetworkNode, Float> resultDenmarkConnection = this.testFreightNetworkFromFile.edge(expectedPortNodeClosestToDenmarkCapital, denmarkCapitalNode);
        Edge<FreightNetworkNode, Float> resultRomaniaConnection = this.testFreightNetworkFromFile.edge(expectedPortNodeClosestToRomaniaCapital, romaniaCapitalNode);
        Edge<FreightNetworkNode, Float> resultCanadaConnection = this.testFreightNetworkFromFile.edge(expectedPortNodeClosestToCanadaCapital, canadaCapitalNode);
    ...
    public void testAcceptanceCriteriaConnectionPortToNClosestPorts(){
        ...
        // Assert
        Edge<FreightNetworkNode, Float> resultValenciaAndBarcelonaConnection = this.testFreightNetworkFromFile.edge(originPortNodeSpain, destinationPortNodeSpainBarcelona);
        Edge<FreightNetworkNode, Float> resultValenciaAndMonacoConnection = this.testFreightNetworkFromFile.edge(originPortNodeSpain, destinationPortNodeMonacoMonaco);

        Edge<FreightNetworkNode, Float> resultHalifaxAndNewJerseyConnection = this.testFreightNetworkFromFile.edge(originPortNodeCanada, destinationPortNodeUSANewJersey);
        Edge<FreightNetworkNode, Float> resultHalifaxAndHortaConnection = this.testFreightNetworkFromFile.edge(originPortNodeCanada, destinationPortNodePortugalHorta);
        Edge<FreightNetworkNode, Float> resultHalifaxAndPontaDelgadaConnection = this.testFreightNetworkFromFile.edge(originPortNodeCanada, destinationPortNodePortugalPontaDelgada);
    ...
    public void printGraph(){
        System.out.println("___________________________FILE GRAPH VERTICES____________");
        for(FreightNetworkNode vertice : this.testFreightNetworkFromFile.vertices()){
            System.out.println(vertice);
        }
        System.out.println("______________________________________________________\n\n");

        System.out.println("___________________________FILE GRAPH EDGES______________");
        for(Edge<FreightNetworkNode, Float> edge : this.testFreightNetworkFromFile.edges()){
