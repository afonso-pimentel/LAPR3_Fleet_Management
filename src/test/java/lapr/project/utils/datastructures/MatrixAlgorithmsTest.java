...
class MatrixAlgorithmsTest {
    ...
    public void testminDistGraph() {
        /*Graph<Integer,Integer> smallMap = new MatrixGraph<>(false);
        smallMap.vertex(1);
        smallMap.vertex(2);
        smallMap.vertex(3);
        smallMap.vertex(4);

        smallMap.addEdge(1,3,2);
        smallMap.addEdge(3,2,3);
        smallMap.addEdge(3,4,2);
        smallMap.addEdge(4,2,1);
        smallMap.addEdge(2,1,4);

        Algorithms.minDistGraph(smallMap, Integer::compare, Integer::sum, Integer.MAX_VALUE);*/
    }
