...
-- insert containers
    ...
    VALUES ('US407_CT001', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID01;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT002', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID02;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT003', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID03;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT004', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID04;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT005', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID05;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT006', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID06;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT007', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID07;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT008', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID08;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT009', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID09;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT010', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID10;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT011', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID11;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT012', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID12;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT013', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID13;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT014', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID14;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT015', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID15;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT016', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID16;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT017', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID17;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT018', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID18;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT019', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID19;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT020', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID20;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT021', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID21;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT022', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID22;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT023', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID23;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT024', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID24;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT025', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID25;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT026', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID26;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT027', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID27;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT028', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID28;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT029', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID29;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT030', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID30;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT031', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID31;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT032', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID32;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT033', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID33;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT034', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID34;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT035', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID35;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT036', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID36;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT037', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID37;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT038', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID38;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT039', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID39;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT040', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID40;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT041', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID41;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT042', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID42;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT043', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID43;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT044', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID44;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT045', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID45;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT046', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID46;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT047', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID47;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT048', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID48;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT049', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
    returning ID into vContainerID49;
    INSERT INTO CONTAINER (IDENTIFICATIONNUMBER, ISOCOD, MAXWEIGHT, TAREWEIGHT, MAXVOLUME, REPAIR, TEMPERATURE, IDCSC)
    VALUES ('US407_CT050', '45G1', 32500, 3830, 20.3, TO_DATE('2023-12-04', 'YYYY-MM-DD HH24:MI:SS'), 4.00, '"n/a"')
...
-- insert ships
    ...
    VALUES (vShipTransportID01, 200000001, 'US407_SP01', 'US407_SHIP_01', 2000001, 5, 1000, 15, 100, 16, 10, 6);
    insert into SHIP (IDTRANSPORT, MMSI, CALLSIGN, NAME, IMONUMBER, GENERATORS, OUTPUTGENERATOR, VESSELTYPE, LENGTH,
                      WIDTH, CAPACITY, DRAFT)
    VALUES (vShipTransportID02, 200000002, 'US407_SP02', 'US407_SHIP_02', 2000002, 5, 1000, 15, 100, 16, 10, 6);
    insert into SHIP (IDTRANSPORT, MMSI, CALLSIGN, NAME, IMONUMBER, GENERATORS, OUTPUTGENERATOR, VESSELTYPE, LENGTH,
                      WIDTH, CAPACITY, DRAFT)
    VALUES (vShipTransportID03, 200000003, 'US407_SP03', 'US407_SHIP_03', 2000003, 5, 1000, 15, 100, 16, 10, 6);
    insert into SHIP (IDTRANSPORT, MMSI, CALLSIGN, NAME, IMONUMBER, GENERATORS, OUTPUTGENERATOR, VESSELTYPE, LENGTH,
                      WIDTH, CAPACITY, DRAFT)
    VALUES (vShipTransportID04, 200000004, 'US407_SP04', 'US407_SHIP_04', 2000004, 5, 1000, 15, 100, 16, 10, 6);
    insert into SHIP (IDTRANSPORT, MMSI, CALLSIGN, NAME, IMONUMBER, GENERATORS, OUTPUTGENERATOR, VESSELTYPE, LENGTH,
                      WIDTH, CAPACITY, DRAFT)
    VALUES (vShipTransportID05, 200000005, 'US407_SP05', 'US407_SHIP_05', 2000005, 5, 1000, 15, 100, 16, 10, 6);
    insert into SHIP (IDTRANSPORT, MMSI, CALLSIGN, NAME, IMONUMBER, GENERATORS, OUTPUTGENERATOR, VESSELTYPE, LENGTH,
                      WIDTH, CAPACITY, DRAFT)
    VALUES (vShipTransportID06, 200000006, 'US407_SP06', 'US407_SHIP_06', 2000006, 5, 1000, 15, 100, 16, 10, 6);
    insert into SHIP (IDTRANSPORT, MMSI, CALLSIGN, NAME, IMONUMBER, GENERATORS, OUTPUTGENERATOR, VESSELTYPE, LENGTH,
                      WIDTH, CAPACITY, DRAFT)
    VALUES (vShipTransportID07, 200000007, 'US407_SP07', 'US407_SHIP_07', 2000007, 5, 1000, 15, 100, 16, 10, 6);
    insert into SHIP (IDTRANSPORT, MMSI, CALLSIGN, NAME, IMONUMBER, GENERATORS, OUTPUTGENERATOR, VESSELTYPE, LENGTH,
                      WIDTH, CAPACITY, DRAFT)
    VALUES (vShipTransportID08, 200000008, 'US407_SP08', 'US407_SHIP_08', 2000008, 5, 1000, 15, 100, 16, 10, 6);
    insert into SHIP (IDTRANSPORT, MMSI, CALLSIGN, NAME, IMONUMBER, GENERATORS, OUTPUTGENERATOR, VESSELTYPE, LENGTH,
                      WIDTH, CAPACITY, DRAFT)
    VALUES (vShipTransportID09, 200000009, 'US407_SP09', 'US407_SHIP_09', 2000009, 5, 1000, 15, 100, 16, 10, 6);
    insert into SHIP (IDTRANSPORT, MMSI, CALLSIGN, NAME, IMONUMBER, GENERATORS, OUTPUTGENERATOR, VESSELTYPE, LENGTH,
                      WIDTH, CAPACITY, DRAFT)
    VALUES (vShipTransportID10, 200000010, 'US407_SP10', 'US407_SHIP_10', 2000010, 5, 1000, 15, 100, 16, 10, 6);
...
-- get cargosites
    ...
    insert into CARGOSITE (NAME, LATITUDE, LONGITUDE, IDCOUNTRY, IDCARGOSITETYPE, CONTAINERCAPACITY, SHIPCAPACITY,
                           TRUCKCAPACITY)
    values ('Port_Portugal_A_407', 20, 20, 'Portugal', vCargositeTypeID, 100000, 10, 200)
    returning ID into vCargosite01;

    insert into CARGOSITE (NAME, LATITUDE, LONGITUDE, IDCOUNTRY, IDCARGOSITETYPE, CONTAINERCAPACITY, SHIPCAPACITY,
                           TRUCKCAPACITY)
    values ('Port_Brazil_407', 20, 20, 'Brazil', vCargositeTypeID, 100000, 10, 200)
    returning ID into vCargosite02;

        insert into CARGOSITE (NAME, LATITUDE, LONGITUDE, IDCOUNTRY, IDCARGOSITETYPE, CONTAINERCAPACITY, SHIPCAPACITY,
                           TRUCKCAPACITY)
    values ('Wareh_Portugal_407', 20, 20, 'Portugal', vCargositeTypeID, 100000, 10, 200)
    returning ID into vCargosite03;


    -- inserts cargo manifests for trucks comming to port
-- a week 7,8,9,10,11,12,13

-- in range of month 02/2022 day 07
-- truck 01 outside of week
    ...
    values (vTruckTransportID01, vCargosite03, vCargosite01, vCargoManifestTypeLoad,
            TO_DATE('01/02/2022', 'dd/MM/yyyy'), NULL,
            TO_DATE('01/02/2022', 'dd/MM/yyyy'), TO_DATE('06/02/2022', 'dd/MM/yyyy'))
...
-- truck 02 inside of week day 7
    insert into CARGOMANIFEST (IDTRANSPORT, IDCARGOSITEORIGIN, IDCARGOSITEDESTINATION, IDCARGOMANIFESTTYPE, DATESTART,
                               DATEFINISH, DATESTARTESTIMATED, DATEFINISHESTIMATED)
    values (vTruckTransportID02, vCargosite03, vCargosite01, vCargoManifestTypeLoad,
            TO_DATE('02/02/2022', 'dd/MM/yyyy'), NULL,
            TO_DATE('02/02/2022', 'dd/MM/yyyy'), TO_DATE('07/02/2022', 'dd/MM/yyyy'))
    returning ID into vTruckCargoManifestIDTemp;
...
-- truck 05 day 8
    ...
    values (vTruckTransportID05, vCargosite03, vCargosite01, vCargoManifestTypeLoad,
            TO_DATE('03/02/2022', 'dd/MM/yyyy'), NULL,
            TO_DATE('03/02/2022', 'dd/MM/yyyy'), TO_DATE('08/02/2022', 'dd/MM/yyyy'))
    returning ID into vTruckCargoManifestIDTemp;
...
-- truck 09
    ...
    values (vTruckTransportID09, vCargosite03, vCargosite01, vCargoManifestTypeLoad,
            TO_DATE('04/02/2022', 'dd/MM/yyyy'), NULL,
            TO_DATE('04/02/2022', 'dd/MM/yyyy'), TO_DATE('09/02/2022', 'dd/MM/yyyy'))
    returning ID into vTruckCargoManifestIDTemp;
...
-- truck 12
    ...
    values (vTruckTransportID12, vCargosite03, vCargosite01, vCargoManifestTypeLoad,
            ...
            TO_DATE('05/02/2022', 'dd/MM/yyyy'), TO_DATE('10/02/2022', 'dd/MM/yyyy'))
    returning ID into vTruckCargoManifestIDTemp;
...
-- truck 15
    ...
    values (vTruckTransportID15, vCargosite03, vCargosite01, vCargoManifestTypeLoad,
            TO_DATE('06/02/2022', 'dd/MM/yyyy'), NULL,
            TO_DATE('06/02/2022', 'dd/MM/yyyy'), TO_DATE('11/02/2022', 'dd/MM/yyyy'))
    returning ID into vTruckCargoManifestIDTemp;
...
-- truck 17
    ...
    values (vTruckTransportID17, vCargosite03, vCargosite01, vCargoManifestTypeLoad,
            NULL, NULL,
            TO_DATE('07/02/2022', 'dd/MM/yyyy'), TO_DATE('12/02/2022', 'dd/MM/yyyy'))
    returning ID into vTruckCargoManifestIDTemp;
...
-- truck 18
    ...
    values (vTruckTransportID18, vCargosite03, vCargosite01, vCargoManifestTypeLoad,
            NULL, NULL,
            TO_DATE('08/02/2022', 'dd/MM/yyyy'), TO_DATE('13/02/2022', 'dd/MM/yyyy'))
    returning ID into vTruckCargoManifestIDTemp;
...
-- truck 20
    ...
    values (vTruckTransportID20, vCargosite03, vCargosite01, vCargoManifestTypeLoad,
            NULL, NULL,
            TO_DATE('09/02/2022', 'dd/MM/yyyy'), TO_DATE('14/02/2022', 'dd/MM/yyyy'))
    returning ID into vTruckCargoManifestIDTemp;
    ...
    -- trucks leaving port
-- in range of month 02/2022 day 7
...
-- truck 9
    ...
    values (vTruckTransportID09, vCargosite01, vCargosite03, vCargoManifestTypeLoad,
            NULL, NULL,
            TO_DATE('10/02/2022', 'dd/MM/yyyy'), TO_DATE('15/02/2022', 'dd/MM/yyyy'))
    returning ID into vTruckCargoManifestIDTemp;
...
-- truck 12
    ...
    values (vTruckTransportID12, vCargosite01, vCargosite03, vCargoManifestTypeLoad,
            NULL, NULL,
            TO_DATE('11/02/2022', 'dd/MM/yyyy'), TO_DATE('16/02/2022', 'dd/MM/yyyy'))
    returning ID into vTruckCargoManifestIDTemp;
...
-- truck 15
    ...
    values (vTruckTransportID15, vCargosite01, vCargosite03, vCargoManifestTypeLoad,
            NULL, NULL,
            TO_DATE('12/02/2022', 'dd/MM/yyyy'), TO_DATE('17/02/2022', 'dd/MM/yyyy'))
    returning ID into vTruckCargoManifestIDTemp;
...
-- out of range of month 02/2022 (less, ship 01)
    insert into CARGOMANIFEST (IDTRANSPORT, IDCARGOSITEORIGIN, IDCARGOSITEDESTINATION, IDCARGOMANIFESTTYPE, DATESTART,
                               DATEFINISH, DATESTARTESTIMATED, DATEFINISHESTIMATED)
    values (vShipTransportID01, vCargosite02, vCargosite01, vCargoManifestTypeLoad,
            TO_DATE('01/02/2022', 'dd/MM/yyyy'), TO_DATE('05/02/2022', 'dd/MM/yyyy'),
            TO_DATE('01/02/2022', 'dd/MM/yyyy'), TO_DATE('05/02/2022', 'dd/MM/yyyy'))
...
-- ship 02
    insert into CARGOMANIFEST (IDTRANSPORT, IDCARGOSITEORIGIN, IDCARGOSITEDESTINATION, IDCARGOMANIFESTTYPE, DATESTART,
                               DATEFINISH, DATESTARTESTIMATED, DATEFINISHESTIMATED)
    values (vShipTransportID02, vCargosite02, vCargosite01, vCargoManifestTypeLoad,
            TO_DATE('02/02/2022', 'dd/MM/yyyy'), NULL,
            TO_DATE('02/02/2022', 'dd/MM/yyyy'), TO_DATE('07/02/2022', 'dd/MM/yyyy'))
    returning ID into vShipCargoManifestIDTemp;
...
-- ship 03
    insert into CARGOMANIFEST (IDTRANSPORT, IDCARGOSITEORIGIN, IDCARGOSITEDESTINATION, IDCARGOMANIFESTTYPE, DATESTART,
                               DATEFINISH, DATESTARTESTIMATED, DATEFINISHESTIMATED)
    values (vShipTransportID03, vCargosite02, vCargosite01, vCargoManifestTypeLoad,
            TO_DATE('02/02/2022', 'dd/MM/yyyy'), NULL,
            TO_DATE('02/02/2022', 'dd/MM/yyyy'), TO_DATE('08/02/2022', 'dd/MM/yyyy'))
    returning ID into vShipCargoManifestIDTemp;
...
-- ship 04
    insert into CARGOMANIFEST (IDTRANSPORT, IDCARGOSITEORIGIN, IDCARGOSITEDESTINATION, IDCARGOMANIFESTTYPE, DATESTART,
                               DATEFINISH, DATESTARTESTIMATED, DATEFINISHESTIMATED)
    values (vShipTransportID04, vCargosite02, vCargosite01, vCargoManifestTypeLoad,
            TO_DATE('04/02/2022', 'dd/MM/yyyy'), NULL,
            TO_DATE('04/02/2022', 'dd/MM/yyyy'), TO_DATE('09/02/2022', 'dd/MM/yyyy'))
    returning ID into vShipCargoManifestIDTemp;
...
-- ship 05
    insert into CARGOMANIFEST (IDTRANSPORT, IDCARGOSITEORIGIN, IDCARGOSITEDESTINATION, IDCARGOMANIFESTTYPE, DATESTART,
                               DATEFINISH, DATESTARTESTIMATED, DATEFINISHESTIMATED)
    values (vShipTransportID05, vCargosite02, vCargosite01, vCargoManifestTypeLoad,
            TO_DATE('05/02/2022', 'dd/MM/yyyy'), NULL,
            TO_DATE('05/02/2022', 'dd/MM/yyyy'), TO_DATE('10/02/2022', 'dd/MM/yyyy'))
    returning ID into vShipCargoManifestIDTemp;
...
-- ship 06
    insert into CARGOMANIFEST (IDTRANSPORT, IDCARGOSITEORIGIN, IDCARGOSITEDESTINATION, IDCARGOMANIFESTTYPE, DATESTART,
                               DATEFINISH, DATESTARTESTIMATED, DATEFINISHESTIMATED)
    values (vShipTransportID06, vCargosite02, vCargosite01, vCargoManifestTypeLoad,
            TO_DATE('06/02/2022', 'dd/MM/yyyy'), NULL,
            TO_DATE('06/02/2022', 'dd/MM/yyyy'), TO_DATE('11/02/2022', 'dd/MM/yyyy'))
    returning ID into vShipCargoManifestIDTemp;
...
-- ship 07
    insert into CARGOMANIFEST (IDTRANSPORT, IDCARGOSITEORIGIN, IDCARGOSITEDESTINATION, IDCARGOMANIFESTTYPE, DATESTART,
                               DATEFINISH, DATESTARTESTIMATED, DATEFINISHESTIMATED)
    values (vShipTransportID07, vCargosite02, vCargosite01, vCargoManifestTypeLoad,
            NULL, NULL,
            TO_DATE('07/02/2022', 'dd/MM/yyyy'), TO_DATE('12/02/2022', 'dd/MM/yyyy'))
    returning ID into vShipCargoManifestIDTemp;
...
-- ship 08
    insert into CARGOMANIFEST (IDTRANSPORT, IDCARGOSITEORIGIN, IDCARGOSITEDESTINATION, IDCARGOMANIFESTTYPE, DATESTART,
                               DATEFINISH, DATESTARTESTIMATED, DATEFINISHESTIMATED)
    values (vShipTransportID08, vCargosite02, vCargosite01, vCargoManifestTypeLoad,
            NULL, NULL,
            TO_DATE('08/02/2022', 'dd/MM/yyyy'), TO_DATE('13/02/2022', 'dd/MM/yyyy'))
    returning ID into vShipCargoManifestIDTemp;
...
-- ship 01
    insert into CARGOMANIFEST (IDTRANSPORT, IDCARGOSITEORIGIN, IDCARGOSITEDESTINATION, IDCARGOMANIFESTTYPE, DATESTART,
                               DATEFINISH, DATESTARTESTIMATED, DATEFINISHESTIMATED)
    values (vShipTransportID01, vCargosite01, vCargosite02, vCargoManifestTypeLoad,
            NULL, NULL,
            TO_DATE('09/02/2022', 'dd/MM/yyyy'), TO_DATE('14/02/2022', 'dd/MM/yyyy'))
    returning ID into vShipCargoManifestIDTemp;
...
-- ship 02
    insert into CARGOMANIFEST (IDTRANSPORT, IDCARGOSITEORIGIN, IDCARGOSITEDESTINATION, IDCARGOMANIFESTTYPE, DATESTART,
                               DATEFINISH, DATESTARTESTIMATED, DATEFINISHESTIMATED)
    values (vShipTransportID02, vCargosite01, vCargosite02, vCargoManifestTypeLoad,
            NULL, NULL,
            TO_DATE('10/02/2022', 'dd/MM/yyyy'), TO_DATE('15/02/2022', 'dd/MM/yyyy'))
    returning ID into vShipCargoManifestIDTemp;
...
-- ship 03
    insert into CARGOMANIFEST (IDTRANSPORT, IDCARGOSITEORIGIN, IDCARGOSITEDESTINATION, IDCARGOMANIFESTTYPE, DATESTART,
                               DATEFINISH, DATESTARTESTIMATED, DATEFINISHESTIMATED)
    values (vShipTransportID03, vCargosite01, vCargosite02, vCargoManifestTypeLoad,
            NULL, NULL,
            TO_DATE('11/02/2022', 'dd/MM/yyyy'), TO_DATE('16/02/2022', 'dd/MM/yyyy'))
    returning ID into vShipCargoManifestIDTemp;
...
-- ship 04
    insert into CARGOMANIFEST (IDTRANSPORT, IDCARGOSITEORIGIN, IDCARGOSITEDESTINATION, IDCARGOMANIFESTTYPE, DATESTART,
                               DATEFINISH, DATESTARTESTIMATED, DATEFINISHESTIMATED)
    values (vShipTransportID04, vCargosite01, vCargosite02, vCargoManifestTypeLoad,
            NULL, NULL,
            TO_DATE('12/02/2022', 'dd/MM/yyyy'), TO_DATE('17/02/2022', 'dd/MM/yyyy'))
    returning ID into vShipCargoManifestIDTemp;
...
-- ship 05
    insert into CARGOMANIFEST (IDTRANSPORT, IDCARGOSITEORIGIN, IDCARGOSITEDESTINATION, IDCARGOMANIFESTTYPE, DATESTART,
                               DATEFINISH, DATESTARTESTIMATED, DATEFINISHESTIMATED)
    values (vShipTransportID05, vCargosite01, vCargosite02, vCargoManifestTypeLoad,
            NULL, NULL,
            TO_DATE('13/02/2022', 'dd/MM/yyyy'), TO_DATE('18/02/2022', 'dd/MM/yyyy'))
    returning ID into vShipCargoManifestIDTemp;
...
-- ship 06
    insert into CARGOMANIFEST (IDTRANSPORT, IDCARGOSITEORIGIN, IDCARGOSITEDESTINATION, IDCARGOMANIFESTTYPE, DATESTART,
                               DATEFINISH, DATESTARTESTIMATED, DATEFINISHESTIMATED)
    values (vShipTransportID06, vCargosite01, vCargosite02, vCargoManifestTypeLoad,
            NULL, NULL,
            TO_DATE('14/02/2022', 'dd/MM/yyyy'), TO_DATE('19/02/2022', 'dd/MM/yyyy'))
    returning ID into vShipCargoManifestIDTemp;
